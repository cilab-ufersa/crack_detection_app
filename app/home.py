    ...
    with right_column:
        ...
        if source_img is not None:
            ...
            if negative_result > positive_result:
                ...
                if st.button("Analyze Crack", help= "This will redirect you to the crack analysis page, where you can analyze the crack in detail"):
                        st.query_params.update({"page": "other",
                                                "image": binary_path})
                        st.rerun()
        else:
